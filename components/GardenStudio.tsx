...
export default function GardenStudio() {
  ...
  const [status, setStatus] = useState('Bereit: V0.8 mit erweiterten Formaten.');
  ...
  function exportProject(): void {
    const project = { version: '0.8.0', levels: LEVELS, areas, objects, background };
  ...
  function saveBrowser(): void {
    localStorage.setItem(
      STORAGE_KEY,
      JSON.stringify({ version: '0.8.0', levels: LEVELS, areas, objects, background })
    );
