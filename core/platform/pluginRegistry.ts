...
const plugins: StudioPlugin[] = [
  { id: "cad", name: "Professional CAD Core", version: "3.0-alpha.4", status: "active", capabilities: ["detail-tools", "draw", "snap", "select", "align", "dynamic-connectors", "undo-redo"] },
  ...
  { id: "object-library", name: "Object Database", version: "3.0-alpha.4", status: "active", capabilities: ["objects", "plants", "materials", "bim-placement"] },
  { id: "media-import", name: "Media & Reality Capture", version: "3.0-alpha.4", status: "active", capabilities: ["plan-reference", "video-to-3d", "scan-lidar"] },
  { id: "documentation", name: "Documentation", version: "3.0-alpha.4", status: "foundation", capabilities: ["plan-layout", "reports", "revision-data"] },
  { id: "collaboration", name: "Collaboration", version: "3.0-alpha.4", status: "planned", capabilities: ["comments", "tasks", "versioning"] },
  { id: "exchange", name: "Professional Import/Export", version: "3.0-alpha.4", status: "foundation", capabilities: ["algreen", "png", "csv"] }
];
