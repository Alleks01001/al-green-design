...
const plugins: StudioPlugin[] = [
  { id: "cad", name: "Professional CAD Core", version: "3.1-alpha.4.1", status: "active", capabilities: ["detail-tools", "draw", "object-snap", "intersection-snap", "ortho", "precision-transform", "groups", "blocks", "layers", "associative-dimensions", "offset", "mirror", "rectangular-array", "polar-array", "trim-extend", "align", "dynamic-connectors", "undo-redo"] },
  ...
  { id: "object-library", name: "Professional Library", version: "3.1-alpha.4.1", status: "active", capabilities: ["objects", "real-plant-taxa", "construction-assemblies", "soils", "technical-materials", "professional-filters", "large-library-workspace", "bim-placement"] },
  { id: "media-import", name: "Media & Reality Capture", version: "3.1-alpha.4.1", status: "active", capabilities: ["image-reference", "pdf-plan-import", "video-to-3d", "scan-lidar"] },
  { id: "documentation", name: "Documentation", version: "3.1-alpha.4.1", status: "foundation", capabilities: ["pdf-plan-export", "printable-layers", "plan-layout", "reports", "revision-data"] },
  { id: "collaboration", name: "Collaboration", version: "3.1-alpha.4.1", status: "planned", capabilities: ["comments", "tasks", "versioning"] },
  { id: "exchange", name: "Professional Import/Export", version: "3.1-alpha.4.1", status: "foundation", capabilities: ["algreen", "pdf", "png", "csv"] }
];
