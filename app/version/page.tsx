  ...
  return (
    <main style={{ fontFamily: "system-ui, sans-serif", padding: "40px", maxWidth: "820px", margin: "0 auto" }}>
      ...
      <ul>
        ...
        <li>Beschreibungstexte steuern Pool, Teich, Pergola, Rasen, Beet, Sichtschutz, Hecke und gewünschte Baumzahlen</li>
        <li>Lokale Entwurfsvarianten bleiben innerhalb verschobener, verkleinerter und gedrehter Grundstücksgrenzen</li>
